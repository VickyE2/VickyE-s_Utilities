...
public class MutableVec3 implements Vector3, Cloneable {
	...
	public static final MutableVec3 ZERO = MutableVec3.of(0.0, 0.0, 0.0);
	 ...
	 * <ul>
	 * <li><b>Yaw</b> (rotation around the Y-axis): <br>
	 * Defines the horizontal rotation — 0° points along +Z, 90° points along -X,
	 * 180° along -Z, and so on (like a compass heading).</li>
	 * <li><b>Pitch</b> (rotation around the X-axis): <br>
	 * Defines the vertical rotation — 0° is level (horizontal), positive pitch
	 * angles look upward, negative pitch angles look downward.</li>
	 * </ul>
	 *
	 * @param yawDegrees
	...
	public Vector3 getOrtho() {
		...
		if (abs.getX() < abs.getY() && abs.getX() < abs.getZ())
			return this.crossProduct(new Vec3(1, 0, 0)).normalize();
		if (abs.getY() < abs.getZ())
			return this.crossProduct(new Vec3(0, 1, 0)).normalize();
	...
	public boolean equals(Object obj) {
		if (obj.getClass() != MutableVec3.class)
			return false;
