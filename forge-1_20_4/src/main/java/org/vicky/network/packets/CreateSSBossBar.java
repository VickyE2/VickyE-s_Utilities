...
public record CreateSSBossBar(UUID id, Component title, Component subTitle, float progress, String hex, @Nullable ResourceLocation image) {
    ...
    public static CreateSSBossBar decode(FriendlyByteBuf friendlyByteBuf) {
        return new CreateSSBossBar(
