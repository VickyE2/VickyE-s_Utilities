...
public class ParticleTypeEffect {
  ...
  public static Location[] RIPPLES(
      Location origin,
      double radius,
      double angleStep,
      double angle,
  ...
  public static Location[] BURST_SPIRAL(
      Location origin, double radius, double heightStep, double angle, int particleCount) {
    Location[] positions = new Location[particleCount];
  ...
  public static Location[] FALLING_LEAVES(
      Location origin, double radius, double heightStep, double angle, int particleCount) {
    Location[] positions = new Location[particleCount];
  ...
  public static Location[] EXPLODING_STARS(
      Location origin, double radius, double heightStep, double angle, int particleCount) {
    Location[] positions = new Location[particleCount];
  ...
  public static Location[] PULSE_WAVES(
      Location origin,
      double radius,
      double heightStep,
      double angle,
  ...
  public static Location[] OSCILLATING_RINGS(
      Location origin,
      double radius,
      double heightStep,
      double angle,
