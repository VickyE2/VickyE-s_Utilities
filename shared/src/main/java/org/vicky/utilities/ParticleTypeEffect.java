...
public class ParticleTypeEffect {
	...
	public static PlatformLocation[] HELIX(PlatformLocation origin, double radius, double heightStep, double angle,
			int particleCount) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] RIPPLES(PlatformLocation origin, double radius, double angleStep, double angle,
			int particleCount, SpacingMode spacingMode, int numCircles) {
		if (numCircles <= 0) {
		...
		for (int circleIndex = 0; circleIndex < numCircles; circleIndex++) {
			...
			double sizeFactor = Math.max(0.4 * radius, Math.min(1.2 * radius, angle / 360.0)); // Normalize angle to 0-1
																								// range
			double circleRadius;
	...
	public static PlatformLocation[] WAVY_LINE(PlatformLocation origin, double radius, double heightStep, double angle,
			int particleCount) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] BURST_SPIRAL(PlatformLocation origin, double radius, double heightStep,
			double angle, int particleCount) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] CONVERGING_LINES(PlatformLocation origin, double radius, double heightStep,
			double angle, int particleCount) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] FALLING_LEAVES(PlatformLocation origin, double radius, double heightStep,
			double angle, int particleCount) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] EXPLODING_STARS(PlatformLocation origin, double radius, double heightStep,
			double angle, int particleCount) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] PULSE_WAVES(PlatformLocation origin, double radius, double heightStep,
			double angle, int particleCount, double pFreq) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	public static PlatformLocation[] OSCILLATING_RINGS(PlatformLocation origin, double radius, double heightStep,
			double angle, int particleCount, double rFreq) {
		PlatformLocation[] positions = new PlatformLocation[particleCount];
	...
	private static Vec3 rotateAroundAxis(Vec3 v, Vec3 axis, double angle) {
		...
		return v.multiply(cosTheta).add(axis.crossProduct(v).multiply(sinTheta))
				.add(axis.multiply(axis.dot(v) * (1 - cosTheta)));
	}

	public enum ParticleTypeEffects {
		LINE, HELIX, WAVY_LINE, BURST_SPIRAL, CONVERGING_LINES, RIPPLES, FALLING_LEAVES, EXPLODING_STARS, PULSE_WAVES, OSCILLATING_RINGS
	}
