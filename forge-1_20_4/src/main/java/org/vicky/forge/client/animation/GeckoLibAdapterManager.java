...
/**
 * Manages a lightweight per-entity animatable wrapper used purely for playing animations
 * via GeckoLib controllers. This class is client-only.
 */
public final class GeckoLibAdapterManager {
    ...
    public static void playAnimationClient(Integer entityId, String animationKey, Boolean loop) {
        ...
        if (!(e instanceof PlatformBasedLivingEntity pb)) return;
