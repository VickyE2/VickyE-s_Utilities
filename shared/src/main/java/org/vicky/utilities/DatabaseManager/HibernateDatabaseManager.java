...
public class HibernateDatabaseManager {
	private static final ContextLogger logger = new ContextLogger(ContextLogger.ContextType.HIBERNATE, "UTIL");
	...
	public <T> void saveEntity(T entity) {
		...
		try {
			...
			logger.print("Error during entity saving: " + var8, true);
			if (transaction != null) {
	...
	public <T> void updateEntity(T entity) {
		...
		try {
			...
			logger.print("Error during entity updating:" + var8, true);
			if (transaction != null) {
				transaction.rollback();
			}
	...
	public <T> boolean entityExists(Class<T> clazz, Object id) {
		...
		try {
			...
			logger.print("Error during entity query: " + var11, true);
	...
	public <T> boolean entityExistsByNaturalId(Class<T> clazz, String naturalIdProperty, Object naturalIdValue) {
		...
		try {
			...
			logger.print("Error during natural ID query: " + var10, true);
	...
	public <T> void deleteEntity(T entity) {
		...
		try {
			...
			logger.print("Error during entity deletion: " + var8, true);
			if (transaction != null) {
				transaction.rollback();
			}
