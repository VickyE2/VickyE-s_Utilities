...
public class MusicPlaylist implements DatabaseTemplate {
	@JoinTable(name = "pieces", joinColumns = @JoinColumn(name = "piece_id"), inverseJoinColumns = @JoinColumn(name = "playlist_id"))
	...
	public final LocalDateTime dateCreated = LocalDateTime.now();
