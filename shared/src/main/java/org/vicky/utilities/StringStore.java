...
public class StringStore {
	...
	public void storeString(String pluginName, String identifier, String string) {
		...
		// Get the list for the identifier within the plugin's map, or create one if it
		// doesn't exist
	...
	public List<String> returnStoredStrings(String pluginName, String identifier) {
		// Get the plugin's map and then retrieve the list of strings for the
		// identifier, or return an
		// empty list
		return pluginStringMap.getOrDefault(pluginName, new HashMap<>()).getOrDefault(identifier, new ArrayList<>());
	}
	...
	public Map<String, List<String>> returnAllStringsForPlugin(String pluginName) {
		// Return the entire map of identifiers and their corresponding strings for the
		// plugin
