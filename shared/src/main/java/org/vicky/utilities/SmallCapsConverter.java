 ...
 * <p>
 * For example, the input "RING OF ACCELERATION" is converted into:
 * "ʀɪɴɢ ᴏғ ᴀᴄᴄᴇʟᴇʀᴀᴛɪᴏɴ".
 * </p>
 */
public class SmallCapsConverter {
   ...
   * <p>
   * The method first converts the input to uppercase. Then, for each character in the
   * range A–Z, it replaces it with the corresponding small-cap letter from the mapping.
   * Non-alphabetic characters are appended unchanged.
   * </p>
   *
   * @param input the input string to convert; may be null
