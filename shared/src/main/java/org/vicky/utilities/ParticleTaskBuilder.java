...
public class ParticleTaskBuilder {
	...
	private IColor headColor = new VanillaColor(200, 150, 0);
	private IColor transitionColorStart = new VanillaColor(200, 0, 200);
	private IColor transitionColorEnd = new VanillaColor(0, 0, 200);
	...
	private ParticleTypeEffect.ParticleTypeEffects effectTypeH = ParticleTypeEffect.ParticleTypeEffects.HELIX;
	private ParticleTypeEffect.ParticleTypeEffects effectTypeM = ParticleTypeEffect.ParticleTypeEffects.PULSE_WAVES;
	...
	public ParticleTaskBuilder setHeadColor(IColor headColor) {
		this.headColor = headColor;
		return this;
	}

	public ParticleTaskBuilder setTransitionColorStart(IColor transitionColorStart) {
		this.transitionColorStart = transitionColorStart;
		return this;
	}

	public ParticleTaskBuilder setTransitionColorEnd(IColor transitionColorEnd) {
	...
	public ParticleTask build() {
		return new ParticleTask(startTime, arrow, radiusH, radiusM, heightStep, headColor, transitionColorStart,
				transitionColorEnd, headCount, middleCount, spreadXH, spreadYH, spreadZH, spreadXM, spreadYM, spreadZM,
				speedH, speedM, lagBehind, backwardVelocity, sizeH, sizeM, particleH, particleM, effectTypeH,
				effectTypeM, rFreq, pFreq, angleStep, spacingMode, circleNumber, yaw, pitch);
	}
}
