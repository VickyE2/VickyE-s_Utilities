...
/**
 * A ClassLoaderService implementation that delegates class/resource loading to
 * an aggregated class loader.
 */
public class AggregatedClassLoaderService implements ClassLoaderService {
	...
	/**
	 * Loads the class with the given name by delegating to the aggregated class
	 * loader.
	 */
	@Override
	public <T> Class<T> classForName(String name) {
		try {
			System.out.println("loaders: " + ((AggregatedClassLoader) aggregatedClassLoader).getLoaders());
	...
	/**
	 * Loads the class with the given type name by delegating to the aggregated
	 * class loader.
	 */
	@Override
