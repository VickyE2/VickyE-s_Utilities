...
public class Version implements Comparable<Version> {
	...
	/**
	 * Compare semantically: major, then each subversion, then suffix (null > any
	 * suffix).
	 */
	@Override
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof Version v))
			return false;
		return major == v.major && Objects.equals(subs, v.subs) && Objects.equals(rawSuffix, v.rawSuffix);
	}
	...
	public enum Stage {
		...
		UNKNOWN(-1), SNAPSHOT(3), ALPHA(0), BETA(1), RC(2), // release candidate
		HOTFIX(4),
		// final release
		FINAL(5);
