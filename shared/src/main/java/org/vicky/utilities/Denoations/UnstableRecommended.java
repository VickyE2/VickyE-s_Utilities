...
/**
 * Marks a parameter or method as unstable but recommended for use. Indicates
 * that the API may change in future versions.
 *
 * <p>
 * ⚠️ Indicates that the annotated element is unstable and may change in future
